...
public class GamePanel extends JPanel implements ActionListener{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 983730958565809029L;
    ...
    public void draw(Graphics g) {
        if (running) {
            ...
            g.setFont(new Font("Zero Hour", Font.BOLD, 20));
    ...
    public void gameOver(Graphics g) {
        g.setColor(Color.WHITE);
        g.setFont(new Font("Zero Hour", Font.BOLD, 75));
        FontMetrics metrics  =getFontMetrics(g.getFont());
        g.drawString("UNLUCKY", (SCREEN_WIDTH-metrics.stringWidth("UNLUCKY"))/2, SCREEN_HEIGHT/2);
    }
